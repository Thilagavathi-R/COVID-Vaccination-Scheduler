...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Assembly Hall</h3>
	</div>
	<div class="card-body">
		<form action="" id="assembly-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="room_name" class="control-label">Hall/Room Name</label>
            ...
            <div class="form-group">
				<label for="status" class="control-label">Status</label>
               	<select name="status" id="status" class="custom-select">
					   ...
					   <option value="0" <?php echo isset($status) && $status == 10 ? "selected" : "" ?>>Inactive</option>
				   </select>
			</div>
		</form>
	</div>
